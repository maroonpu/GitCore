...
#define DEFAULT_SAMPLE_RATE      (8000)//采样率
#define DEFAULT_SAMPLE_LENGTH    (16) //量化位数 bits_per_samples 8、16、32位
#define DEFAULT_DURATION_TIME    (10)//录音时长 
...
{ 
    ...
    // snd_output_close(record.log); //打印调试信息相关
...
Err: 
    ...
    // if (record.log) snd_output_close(record.log);//打印调试信息相关 
